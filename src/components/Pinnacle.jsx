...
const Pinnacle = () => {
  return (
    <section className="relative sectionWidth pinnacleSection w-fit h-full">
      ...
      <div className="wrapper py-30 grid md:grid-cols-2 w-full">
        <div className="relative z-10 uppercase">
          <h1 className="text-[1.4rem] md:text-[2.5rem] font-light leading-12">
            This is the{' '}
            <span style={{ color: 'var(--primary-blue)' }}>pinnacle</span>
            <br /> of real estate media.
          </h1>
        </div>
        <div className="grid z-10 pl-5 w-full gap-6">
